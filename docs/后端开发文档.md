...
### 注意事项
* 企业中不使用GORM提供的自动建表migration()，一般手动建表（使用config/newclip.sql建表）
...
APIfox返回的时间
```t
/newclip/user/register/  66ms
/newclip/user/login/  57ms
/newclip/user/ 5ms
/newclip/publish/action/ 1MB 的视频 180ms（偶尔蹦到很高）  3MB 的视频 在270ms  （似乎第一次发会蹦到很高） 接口时间随视频大小上升 500KB的视频 只需要140ms
/newclip/feed/ 登录7ms 未登录6ms
/newclip/publish/list/ 7ms 视频数量176个

/newclip/favorite/action/ 15ms
/newclip/favorite/list/ 6ms
/newclip/comment/action/ 14ms
/newclip/comment/list/ 6ms

/newclip/relation/action/ 13ms
/newclip/relation/follow/list/ 6ms
/newclip/relation/follower/list/ 6ms
/newclip/relation/friend/list/ 6ms

/newclip/message/action/  11ms
/newclip/message/chat/ 4ms
```

fiber返回的时间  这是在docker内
```t
/newclip/user/register/  62ms
/newclip/user/login/  54ms
/newclip/user/ 0.8ms
/newclip/publish/action/ 1MB 的视频 145ms（偶尔蹦到很高）  3MB 的视频 在230ms  （似乎第一次发会蹦到很高） 接口时间随视频大小上升 500KB的视频 只需要130ms
/newclip/feed/ 登录3ms 未登录1.8ms
/newclip/publish/list/ 3ms 视频数量176个

/newclip/favorite/action/ 13ms
/newclip/favorite/list/ 3ms
/newclip/comment/action/ 11ms
/newclip/comment/list/ 2ms

/newclip/relation/action/ 12ms
/newclip/relation/follow/list/ 2.2ms
/newclip/relation/follower/list/ 2.0ms
/newclip/relation/friend/list/ 2.7ms

/newclip/message/action/  8ms
/newclip/message/chat/ 1.2ms
```
